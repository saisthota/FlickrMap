                ...
                <div class="col-lg-4">
                    <form name="changePwd" method="POST" action="ChangePasswordProcess.php">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>New Password:</td>
                                <td><input type="password" name="password" placeholder="New Password" id="password" class="form-control" required></td>
                            </tr>
                            <tr>
                                <td colspan="2"><input type="submit" id="change" class="btn btn-primary" value="Change Password"></td>
                            </tr>
                        </table>
                    </form>
                </div>
